...
```{r descSocioDemo1, results='asis', fig.cap="Moyenne et écarts-types des indicateurs de précarité sociale. Source : RP 2011/INSEE. Calculs : Joël Gombin.", eval=FALSE}
library(Hmisc)
library(htmlTable)
library(pander)
bind_rows(
...
```{r descSocioDemo2, results='asis', fig.cap="Moyenne et écarts-types des indicateurs de précarité sociale. Source : RP 2011/INSEE. Calculs : Joël Gombin.", eval=FALSE}
...
```{r descRevenus, results='asis', fig.cap="Moyenne et écarts-types des indicateurs de revenu et d'inégalités. Source : RP 2011/INSEE. Calculs : Joël Gombin.", eval=FALSE}
